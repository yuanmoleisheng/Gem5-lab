#!/bin/bash
# 脚本说明：一键执行mem_random_access的7组配置测试，自动保存stats.txt
# gem5根目录和基准程序路径
GEM5_ROOT="./"
# 基准程序路径
BENCH_PATH="./lab2/lab2_2/mem_random_access"
# 结果保存目录
RESULT_DIR="${GEM5_ROOT}/lab2_2_results/mem_random_access"
mkdir -p ${RESULT_DIR}
...
run_test() {
    ...
    ./build/X86/gem5.opt ./configs/deprecated/example/se.py \
        ...
        ${extra_params}
    # 保存stats.txt
    cp ./m5out/stats.txt ${RESULT_DIR}/mem_random_access-stats_${config_num}.txt
